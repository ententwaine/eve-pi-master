        ...
        <header className="topnav">
            ...
            <div className={`topnav-content ${isMobileMenuOpen ? 'open' : ''}`}>
                <nav className="topnav-links">
                    ...
                    <NavLink to="/eye" className={({ isActive }) => `topnav-link ${isActive ? 'active' : ''}`} onClick={closeMenu}>
                        PI Eye
                    </NavLink>
                ...
                <div className="topnav-controls">
                    ...
                    <div className="dropdown" style={{ marginLeft: 'var(--space-md)' }}>
                        <span className="topnav-link" style={{ cursor: 'pointer', padding: 'var(--space-sm)' }}>
                        ...
                        <div className="dropdown-content" style={{ right: 0, left: 'auto', minWidth: '150px' }}>
                            <NavLink to="/settings" className="topnav-link" style={{ padding: 'var(--space-md)' }} onClick={closeMenu}>
                                Settings
                            </NavLink>
                        </div>
                    </div>
