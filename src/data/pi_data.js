...
export const commodities = [
    ...
    { id: 2308, name: "Suspended Plasma", tier: "P0", inputs: [], outputYield: 1 },
        ...
        { id: 15317, name: "Genetically Enhanced Livestock", tier: "P2", inputs: [{ id: 2395, quantity: 40 }, { id: 3779, quantity: 40 }], outputYield: 10 },
        { id: 3725, name: "Livestock", tier: "P2", inputs: [{ id: 2395, quantity: 40 }, { id: 2396, quantity: 40 }], outputYield: 10 },
        ...
        { id: 9842, name: "Miniature Electronics", tier: "P2", inputs: [{ id: 2401, quantity: 40 }, { id: 9828, quantity: 40 }], outputYield: 10 },
        { id: 2463, name: "Nanites", tier: "P2", inputs: [{ id: 2393, quantity: 40 }, { id: 2398, quantity: 40 }], outputYield: 10 },
        { id: 2317, name: "Oxides", tier: "P2", inputs: [{ id: 2392, quantity: 40 }, { id: 3683, quantity: 40 }], outputYield: 10 },
        { id: 2321, name: "Polyaramids", tier: "P2", inputs: [{ id: 2392, quantity: 40 }, { id: 2397, quantity: 40 }], outputYield: 10 },
        { id: 3695, name: "Polytextiles", tier: "P2", inputs: [{ id: 2396, quantity: 40 }, { id: 2397, quantity: 40 }], outputYield: 10 },
        { id: 9830, name: "Rocket Fuel", tier: "P2", inputs: [{ id: 2389, quantity: 40 }, { id: 2390, quantity: 40 }], outputYield: 10 },
        { id: 3697, name: "Silicate Glass", tier: "P2", inputs: [{ id: 2392, quantity: 40 }, { id: 9828, quantity: 40 }], outputYield: 10 },
        { id: 9838, name: "Superconductors", tier: "P2", inputs: [{ id: 2389, quantity: 40 }, { id: 3645, quantity: 40 }], outputYield: 10 },
        { id: 2312, name: "Supertensile Plastics", tier: "P2", inputs: [{ id: 3683, quantity: 40 }, { id: 3779, quantity: 40 }], outputYield: 10 },
        ...
        { id: 2358, name: "Biotech Research Reports", tier: "P3", inputs: [{ id: 2463, quantity: 10 }, { id: 3725, quantity: 10 }, { id: 3828, quantity: 10 }], outputYield: 6 },
        { id: 2345, name: "Camera Drones", tier: "P3", inputs: [{ id: 3697, quantity: 10 }, { id: 9830, quantity: 10 }], outputYield: 6 },
        { id: 2344, name: "Condensates", tier: "P3", inputs: [{ id: 2317, quantity: 10 }, { id: 9832, quantity: 10 }], outputYield: 6 },
        { id: 2367, name: "Cryoprotectant Solution", tier: "P3", inputs: [{ id: 2319, quantity: 10 }, { id: 3691, quantity: 10 }, { id: 3693, quantity: 10 }], outputYield: 6 },
        { id: 17392, name: "Data Chips", tier: "P3", inputs: [{ id: 2312, quantity: 10 }, { id: 2327, quantity: 10 }], outputYield: 6 },
        { id: 2348, name: "Gel-Matrix Biopaste", tier: "P3", inputs: [{ id: 2317, quantity: 10 }, { id: 2329, quantity: 10 }, { id: 9838, quantity: 10 }], outputYield: 6 },
        { id: 9834, name: "Guidance Systems", tier: "P3", inputs: [{ id: 2328, quantity: 10 }, { id: 9840, quantity: 10 }], outputYield: 6 },
        { id: 2366, name: "Hazmat Detection Systems", tier: "P3", inputs: [{ id: 3695, quantity: 10 }, { id: 3775, quantity: 10 }, { id: 9840, quantity: 10 }], outputYield: 6 },
        { id: 2361, name: "Hermetic Membranes", tier: "P3", inputs: [{ id: 2321, quantity: 10 }, { id: 15317, quantity: 10 }], outputYield: 6 },
        { id: 17898, name: "High-Tech Transmitters", tier: "P3", inputs: [{ id: 2321, quantity: 10 }, { id: 9840, quantity: 10 }], outputYield: 6 },
        { id: 2360, name: "Industrial Explosives", tier: "P3", inputs: [{ id: 3693, quantity: 10 }, { id: 3695, quantity: 10 }], outputYield: 6 },
        ...
        { id: 9846, name: "Planetary Vehicles", tier: "P3", inputs: [{ id: 2312, quantity: 10 }, { id: 3689, quantity: 10 }, { id: 9842, quantity: 10 }], outputYield: 6 },
        { id: 9848, name: "Robotics", tier: "P3", inputs: [{ id: 3689, quantity: 10 }, { id: 9836, quantity: 10 }], outputYield: 6 },
        { id: 2351, name: "Smartfab Units", tier: "P3", inputs: [{ id: 3828, quantity: 10 }, { id: 9842, quantity: 10 }], outputYield: 6 },
        { id: 2349, name: "Supercomputers", tier: "P3", inputs: [{ id: 2328, quantity: 10 }, { id: 9832, quantity: 10 }, { id: 9836, quantity: 10 }], outputYield: 6 },
        { id: 2346, name: "Synthetic Synapses", tier: "P3", inputs: [{ id: 2312, quantity: 10 }, { id: 2319, quantity: 10 }], outputYield: 6 },
